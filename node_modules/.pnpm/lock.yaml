...
packages:
  ...
  mongodb@6.4.0:
    resolution: {integrity: sha512-MdFHsyb1a/Ee0H3NmzWTSLqchacDV/APF0H6BNQvraWrOiIocys2EmTFZPgHxWhcfO94c1F34I9MACU7x0hHKA==}
    engines: {node: '>=16.20.1'}
    peerDependencies:
      '@aws-sdk/credential-providers': ^3.188.0
      '@mongodb-js/zstd': ^1.1.0
  ...
  mongoose@8.1.3:
    resolution: {integrity: sha512-a5MajZSDJiQgy0iQcR+MIpFe7zehGJI4doJ6Dh1MvnGh8/HNNhr5pn07RPA86KCTjP2vuKdffpFmvXxcHiUOjw==}
    engines: {node: '>=16.20.1'}
...
snapshots:
  ...
  mongoose-sequence@6.0.1(mongoose@8.1.3):
    dependencies:
      async: 3.2.5
      lodash: 4.17.21
      mongoose: 8.1.3
